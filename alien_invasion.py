...
class AlienInvasion:
    ...
    def __init__(self):
        """Initiaise the game and create the game resources"""
        pygame.init()
        ...
        self.icon = pygame.image.load("images/shuttle2.bmp")
    ...
    def run_game(self):
        ...
        while True:
            # Watch for keyboard and mouse events and move ship if applicable.
            self._check_events()
            
            if self.game_active:
                # Redraw ship
                self.ship.update()
                # Redraw and remove old bullets
    ...
    def _check_play_button(self, mouse_pos):
        """Start new game if player clicks 'play' button"""
    ...
    def _update_bullets(self):
        ...
        #Remove bullets that are outside the screen from the sprite group
        for bullet in self.bullets.copy():
            if bullet.rect.bottom <= 0:
                self.bullets.remove(bullet)
        # Redraw the bullets group
        self.bullets.update()
    ...
    def _create_fleet(self):
        ...
        # spacing between aliens is one aline width
        alien = Alien(self)
    ...
    def _update_aliens(self):
        """Check if the fleet is at an edge and update alien positions"""
        ...
        # look for aliens that have hit bottom of the screen
